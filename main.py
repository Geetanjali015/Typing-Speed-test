...
p1 = PhotoImage(file='iconsflow\icon3.png')
root.iconphoto(False, p1)
root.iconbitmap("iconsflow\icon1.ico")
...
# CREATING SWITCH UP BUTTON-CHANGES SENTENCES TO BE TRACED ACCORDING TO YOUR LIKINGS
